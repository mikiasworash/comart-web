        ...
        <footer className="relative z-10 pt-20 pb-10">
          <div className="container">
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div className="w-full mb-10">
                  ...
                  <p className="flex items-center text-sm font-medium text-dark">
                    ...
                    <span className="text-gray-300">+251 xxx xx xx xx</span>
                  </p>
                </div>
              </div>
              ...
              <div className="w-full px-4 sm:w-1/2 lg:w-3/12 text-white">
                <div className="w-full mb-10">
                  ...
                  <p className="text-base text-body-color">
                    comart©{new Date().getFullYear()} {" | "} All Rights
                    Reserved.
                  </p>
                </div>
              </div>
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="text-lg font-semibold mb-9 text-dark text-white">
            {" "}
            {header}{" "}
          </h4>
