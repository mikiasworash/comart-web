          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex flex-col mt-6 pb-5 border-b-2 border-gray-200 mb-5">
              <div className="flex">
                ...
                <button className="">{product.category.name}</button>
              </div>
              <div className="flex mt-4">
                <span className="mr-3">SELLER :</span>
                <button className="">{product.vendor.name}</button>
              </div>
            </div>
            <div className="flex">
              ...
              <input
                type="number"
                class="flex w-20 ml-auto items-center rounded-lg border-none font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-100 outline-none focus:outline-none text-md hover:text-black"
                placeholder="1"
              />
              <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded-lg">
                <svg
